      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="mt-6 max-w-xl mx-auto lg:mx-0 scroll-animate delay-200">
            ...
            {/* Social Icons */}
            <div className="mt-12 flex justify-center lg:justify-start items-center space-x-6 scroll-animate delay-400 social-icon-list">
              <a
